...
const (
	MethodHandleCustomTsServerCommand Method = "$/handleCustomTsServerCommand"
)

type HandleCustomTsServerCommandParams struct {
...
func (p *HandleCustomTsServerCommandParams) UnmarshalJSON(data []byte) error {
